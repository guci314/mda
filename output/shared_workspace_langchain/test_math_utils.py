...
class TestMathUtils(unittest.TestCase):
    ...
    def test_subtract_mixed_numbers(self):
        self.assertEqual(MathUtils.subtract(3, 5), -2)

    def test_subtract_float_numbers(self):
        self.assertAlmostEqual(MathUtils.subtract(5.5, 2.5), 3.0)
    ...
    def test_multiply_float_numbers(self):
        self.assertAlmostEqual(MathUtils.multiply(2.5, 3.0), 7.5)
    ...
    def test_divide_float_numbers(self):
        self.assertAlmostEqual(MathUtils.divide(7.5, 2.5), 3.0)
    ...
    def test_power_zero_to_negative_power_error(self):
        with self.assertRaises(ValueError) as cm:
            MathUtils.power(0, -2)
        self.assertEqual(str(cm.exception), "Cannot raise 0 to a negative power.")
