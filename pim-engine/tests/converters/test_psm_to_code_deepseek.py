"""Test PSM to Code generator with DeepSeek"""
...
CACHE_PATH = ".langchain_deepseek_psm_test.db"
set_llm_cache(SQLiteCache(database_path=CACHE_PATH))

from converters.psm_to_code_deepseek import PSMtoCodeDeepSeekGenerator


class TestPSMtoCodeDeepSeekGenerator(unittest.TestCase):
    """测试 PSM to Code 生成器 (DeepSeek)"""
    ...
    @unittest.skipIf(not os.getenv("DEEPSEEK_API_KEY"), "需要设置 DEEPSEEK_API_KEY 环境变量")
